...
Il portale \ |LINK3|\  è il portale open data del comune di Palermo operativo dal dicembre 2017, in sostituzione della \ |LINK4|\ .

Il nuovo portale è conforme allo standard nazionale \ |LINK5|\ . Essere per un portale istituzionale conforme allo standard nazionale DCAT_AP_IT significa che i dataset del portale open data del comune di Palermo sono automaticamente esposti nel portale nazionale open data \ |LINK6|\  upe sempre automaticamente vengono esposti nel portale europeo dei dati in formato aperto \ |LINK7|\ . 

Le \ |STYLE1|\  rispetto alla vecchia versione del portale sono mutate anche se non sono stravolte, e procedere al caricamento con il nuovo pannello di controllo risulta anche un’attività più semplice.
...
Per accedere al pannello di controllo, abilitante al caricamento dei dataset e dei metadati, andare al link \ |LINK8|\  (figura 1).
...
A questo punto si apre il \ |STYLE4|\  (figura 2)
...
E si apre questa schermata con il puls pulsante “\ |STYLE7|\ ” e sotto “\ |STYLE8|\ ” (figura 4)
...
Si clicca “\ |STYLE10|\ ” (figura 5) e si apre un pannello in cui è possibile già vedere i dataset caricati. 

Quindi è possibile cominciare a creare un \ |STYLE11|\ , cliccando sul tasto azzurro “\ |STYLE12|\ ”.
...
Quindi si seleziona il titolo specifico del dataset che già abbiamo editato nella fase precedente e \ |STYLE16|\ .
...
Si apre un'altra schermata (figura 9) e si procede a cliccare sul tasto azzurro “\ |STYLE19|\ ”
...
Si apre la schermata (figura 10) e si continua selezionando il campo a destra  --\ |STYLE21|\ --
...
Si apre la schermata (figura 11) e \ |STYLE23|\ .

Nella stessa schermata si procede a inserire un breve testo nel campo \ |STYLE24|\ . Si può anche scrivere il titolo del dataset, lo stesso titolo utilizzato nella parte precedente per la titolazione del dataset.

Una volta effettuate queste due operazioni si clicca sul tasto in basso a destra “\ |STYLE25|\ ”
...
La schermata successiva (figura 12) si apre con un messaggio: “\ |STYLE27|\ ”.

Quindi si passa all’ultima operazione che è quella di caricamento del file sul pannello di controllo. 

Si clicca sul tasto in basso a destra “\ |STYLE28|\ ”  e si seleziona dal pc il file da caricare.
...
Nel pannello di caricamento del dataset a destra c’è un’\ |STYLE34|\  (figura 13).
...
\ |STYLE37|\  cliccando su questa icona (a forma di nuvoletta di colore azzurro) verrà restituito un messaggio di errore “\ |STYLE38|\ ” come di seguito in figura 14:
...
..  Attention:: 
    ...
    Una volta effettuato il caricamento del dataset sul pannello di controllo può capitare che lo stesso caricamento non sia andato a buon fine, in questo caso \ |STYLE40|\  di: file caricato con il nome \ |STYLE41|\ 
...
.. |STYLE1| replace:: **procedure di caricamento dei dataset e dei metadati**

.. |STYLE2| replace:: **↓**

.. |STYLE3| replace:: **↓**

.. |STYLE4| replace:: **pannello di controllo**

.. |STYLE5| replace:: **↓**

.. |STYLE6| replace:: **↓**

.. |STYLE7| replace:: **Gestione Metadato**

.. |STYLE8| replace:: **Gestione Opendata**

.. |STYLE9| replace:: **↓**

.. |STYLE10| replace:: **Gestione Metadato**

.. |STYLE11| replace:: **NUOVO metadato**

.. |STYLE12| replace:: **Nuovo**

.. |STYLE13| replace:: **↓**

.. |STYLE14| replace:: **Conferma immissione**

.. |STYLE15| replace:: **↓**

.. |STYLE16| replace:: **si clicca nel logo a forma di nuvoletta di colore azzurro con la freccia verso l’alto**

.. |STYLE17| replace:: **↓**

.. |STYLE18| replace:: **↓**

.. |STYLE19| replace:: **Nuovo**

.. |STYLE20| replace:: **↓**

.. |STYLE21| replace:: **Seleziona un valore**

.. |STYLE22| replace:: **↓**

.. |STYLE23| replace:: **si seleziona il formato di dataset da caricare**

.. |STYLE24| replace:: **NOTE**

.. |STYLE25| replace:: **Conferma immissione**

.. |STYLE26| replace:: **↓**

.. |STYLE27| replace:: **Inserimento avvenuto con successo**

.. |STYLE28| replace:: **Carica allegato**
...
.. |STYLE34| replace:: **icona a forma di nuvoletta di colore azzurro**

.. |STYLE35| replace:: **↓**

.. |STYLE36| replace:: **↓**

.. |STYLE37| replace:: **Se la procedura di caricamento non è andata a buon fine**

.. |STYLE38| replace:: **Not Found**

.. |STYLE39| replace:: **↓**

.. |STYLE40| replace:: **non viene visualizzato il messaggio**

.. |STYLE41| replace:: **xxxxxxx.CSV.**
...
.. |LINK4| raw:: html
    ...
    <a href="https://www.comune.palermo.it/opendata.php" target="_blank">precedente versione</a>
